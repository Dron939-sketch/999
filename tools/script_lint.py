...
UNMARKED = [
    (r"индюш(к[ауиеой]|ками)", "индю" + ACCENT + "шка — ударение на Ю"),
    (r"хорьк(а|у|ом|е|и|ов)", "хорька" + ACCENT + " — ударение на окончание"),
    (r"индюшон(ок|ка|ку|ком|ке)", "индюшо" + ACCENT + "нок — ударение на О"),
