...
Порядок работы, выведенный из дня, в котором первый ролик стоил четырнадцать
прогонов завода, второй — два, а третий — один. Что делать в чате, что в файлах,
что после гейтов и почему пуш во время рендера убивает рендер. — `KONVEJER.md`
