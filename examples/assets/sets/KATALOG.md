...
|---|---|---|---|
| `bazaar-obeschanij.svg` | ![bazaar-obeschanij](katalog/bazaar-obeschanij.png) | 0.33 | lektorij-manifest, stanok |
| `biznes-street.svg` | ![biznes-street](katalog/biznes-street.png) | 0.66 | logika, otkaz, lektorij-manifest, biznes-myshlenie-intro |
...
| `derevo-pen.svg` | ![derevo-pen](katalog/derevo-pen.png) | 0.403 | tri-raza, istoriya-religij, logika, stanok |
...
| `kamen-memento.svg` | ![kamen-memento](katalog/kamen-memento.png) | 0.444 | tri-raza, istoriya-religij, stanok |
| `koridor-lovushka.svg` | ![koridor-lovushka](katalog/koridor-lovushka.png) | 0.589 | otkaz, trevoga |
...
| `kuhnya-noch.svg` | ![kuhnya-noch](katalog/kuhnya-noch.png) | 0.431 | tri-raza, logika, privyazannost |
| `kuhnya-schet.svg` | ![kuhnya-schet](katalog/kuhnya-schet.png) | 0.47 | distanciya, logika |
...
| `logika-veer-dorog.svg` | ![logika-veer-dorog](katalog/logika-veer-dorog.png) | 0.35 | — |
