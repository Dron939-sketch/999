...
В этом же кадре стоит МЕТКА КУРСА «10» — белой тушью на груди, в первом и
последнем кадре ролика. Значит за спиной у фигуры не должно быть светлого пятна:
на белой стене белая метка пропадёт. Нужен холодильник или тень тумбы.
